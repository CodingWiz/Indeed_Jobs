...
(function($) {
    $.fn.uploader = function(options) {
      ...
      $(".file-chooser__input").on("change", function() {
        ...
        var blnDoublement = false;
        arrFile.forEach(loop => {
            if (loop == file) {
                blnDoublement = true;
            }
        });
        ...
        if (check === "valid" && !blnDoublement) {
          ...
          uploadId++;
        } else if (blnDoublement) {
            $(".file-chooser").addClass("error");
            var errorText = "Erreur de doublement!!! Mettez seulement un fichier unique a la fois!!!"
  ...
  $(document).ready(function() {
    ...
    /*$(".file-chooser__input").change(function() {
        arrFile.push($(".file-chooser__input").val());
    });*/

    $(".file-uploader__submit-button").click(function() {
        //console.log(arrFile);
        //console.log($(".file-chooser__input").files[0].name);
